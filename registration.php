...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
	...
	elseif(strlen($_POST['phone']) < 7)  //cal phone length
	{
               ...
               <div class="container">
                  ...
                  <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                     ...
                     if(!empty($_SESSION["user_id"])) // if user is not login
							{
									//if user is login
									echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active"> Hi,'.$_SESSION["user_name"].'</a> </li>';
                            }
                            else
                            {
                                echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active"> Hi,Foodie</a> </li>';
                            }
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-8">
                        <div class="widget">
                           <div class="widget-body">
                              <h1> Register and Enjoy your Meal the Foodie Way</h1>
                     ...
                     <div class="col-md-4">
                        ...
                        <hr>
                        <img src="./images/img/MainWeb1.jpg" alt="" class="img-fluid">
                        <p></p>
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>Want to get food on time?</a></h4>
                           </div>
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>Want to Order Meal??</a></h4>
                           </div>
                  ...
                  <div class="row text-img-block text-xs-left">
                     <div class="container">
                        ...
                        <div class="col-xs-12 col-sm-7 left-text">
                           <h3>The Best Food Delivery App - COMING SOON</h3>
                           <p>OUR FOODS ONLINE APP IS UNDER DEVELOPMENT. KEEP WATCHING THIS SPACE TO FIND OUT THE DATES FOR THE RELEASE..</p>
                           <div class="social-btns">
                              <a href="#" class="app-btn apple-button clearfix">
                                 <div class="pull-left"><i class="fa fa-apple"></i> </div>
                                 <div class="pull-right"> <span class="text">Coming soon on</span> <span class="text-2">App Store</span> </div>
                              </a>
                              <a href="#" class="app-btn android-button clearfix">
                                 <div class="pull-left"><i class="fa fa-android"></i> </div>
                                 <div class="pull-right"> <span class="text">Coming soon on</span> <span class="text-2">Play store</span> </div>
                              </a>
                           </div>
                        </div>
                     </div>
               ...
               <div class="row top-footer">
                  ...
                  <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                     ...
                     <ul>
                        ...
                        <li><a>Pay via Payroll</a> </li>
                        <li><a>Wait for delivery</a> </li>
                     </ul>
                  </div>
                  ...
                  <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                     ...
                     <ul>
                        <li><a>Yellow Chillies</a> </li>
                        <li><a>Swaagat</a> </li>
                        <li><a>Indiana</a> </li>
                        <li><a>Aashiyana</a> </li>
                        <li><a>Curry House</a> </li>
                     </ul>
                  </div>
                  ...
                  <div class="col-xs-12 col-sm-2 pages color-gray">
                     <h5>Admin Login</h5>
                     <ul>
                        <li><a href="portal/admin">Admin Portal</a> </li>
                     </ul>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-xs-12 col-sm-3 payment-options color-gray">
                        ...
                        <ul>
                           ...
                           <li>
                              <a> <img src="images/payroll.jfif" alt="Payroll"> </a>
                           </li>
                           <li>
                              <a> <img src="images/cash.png" alt="Cash"> </a>
                           </li>
                        </ul>
                     </div>
                     <div class="col-xs-12 col-sm-4 address color-gray">
                        <h5>Address</h5>
                        <p>The University of the South Pacific - Laucala Campus</p>
                        <h5>Phone: <a href="tel:+679-8382340">+679-8382340</a></h5>
                     </div>
                     <div class="col-xs-12 col-sm-5 additional-info color-gray">
                        <h5>Addition information</h5>
                        <p>Our website is currently under maintenance, we apologize if any inconvience is caused during this period.</p>
                     </div>
                  </div>
               </div>
               <!-- bottom footer ends -->
